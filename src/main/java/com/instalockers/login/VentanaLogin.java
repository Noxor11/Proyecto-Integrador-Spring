package com.instalockers.login;
...
import com.instalockers.ventanaPrincipal.BarraInvisible;
...
public class VentanaLogin extends JFrame implements Vista {
    ...
    /**
     * @see Modelo
     * @see com.instalockers.mvc.Modelo.ResultadoLogin
     * Metodo que actualiza elJFrame dependiendo del resultado que reciba del modelo y da una orden
    ...
    /**
     * @see com.instalockers.mvc.ModeloImpl método escribirFicheroLoguear
