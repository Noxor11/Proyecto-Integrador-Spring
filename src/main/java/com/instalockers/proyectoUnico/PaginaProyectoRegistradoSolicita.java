...
public class PaginaProyectoRegistradoSolicita extends PaginaProyectos {
    ...
    public void imprProyecto(int id) {
        ContenidoPrincipal.controlador.getModelo().obtenerDatosProyecto(id);
        ContenidoPrincipal.controlador.cambiarContenido(Paginas.PAGINA_PROYECTO_MIEMBRO);
    }
